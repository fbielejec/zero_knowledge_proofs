...
* IN-PROGRESS Finite fields: https://www.youtube.com/watch?app=desktop&v=ColSUxhpn6A
** IN-PROGRESS Ring
...
** IN-PROGRESS Difference Between a Ring and a Field
...
- proof that Z_p is a finite field if p is prime (that groups of prime order are fields): https://youtu.be/ColSUxhpn6A?t=1606
 - euler / fermat
 - extended_gcd
* IN-PROGRESS Elementary set theory: https://www.rareskills.io/post/set-theory
** IN-PROGRESS Set
...
** IN-PROGRESS Functions as subsets of cartesian products
